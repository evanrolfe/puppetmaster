...
export const hotKeyRefs = {
  ...
  REQUEST_SHOW_SETTINGS: defineHotKey(
    'request_showSettings',
    'Show Request Settings'
  ),
  ...
  PREFERENCES_SHOW_GENERAL: defineHotKey(
  ...
  SHOW_RECENT_REQUESTS: defineHotKey(
    'request_showRecent',
  ...
  REQUEST_SHOW_OPTIONS: defineHotKey(
    'request_showOptions',
    'Send Request (Options)'
  ),

  ENVIRONMENT_SHOW_EDITOR: defineHotKey(
    'environment_showEditor',
    'Show Environment Editor'
  ),

  ENVIRONMENT_SHOW_SWITCH_MENU: defineHotKey(
  ...
  REQUEST_TOGGLE_HISTORY: defineHotKey(
  ...
  REQUEST_QUICK_CREATE: defineHotKey(
    'request_quickCreate',
  ...
  REQUEST_SHOW_CREATE_FOLDER: defineHotKey(
    'request_showCreateFolder',
    'Create Folder'
  ),

  REQUEST_SHOW_DUPLICATE: defineHotKey(
  ...
  ENVIRONMENT_UNCOVER_VARIABLES: defineHotKey(
    'environment_uncoverVariables',
    'Uncover Variables'
  )
};
...
function copyKeyCombs(sources: Array<KeyCombination>): Array<KeyCombination> {
  ...
  sources.forEach(keyCombSource => {
    targets.push(Object.assign({}, keyCombSource));
  });
  return targets;
}
...
export function areKeyBindingsSameAsDefault(
  ...
  for (const keyCombElement of keyCombs) {
    const found = defaultKeyCombs.find(defKeyComb => {
      if (areSameKeyCombinations(keyCombElement, defKeyComb)) {
        return true;
      }
      return false;
    });
