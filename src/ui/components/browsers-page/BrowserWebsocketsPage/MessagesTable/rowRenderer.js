...
import MessagesTableRowState from './MessagesTableRowState';

/*
 * NOTE: We have monkey-patched the rowRenderer function from react-virtualized
 *       in order to make it use our own MessagesTableRow componenent. This
...
export default function rowRenderer({
  ...
  return (
    <MessagesTableRowState
      key={rowData.id}
      websocketMessageId={rowData.id}
      className={className}
      role="row"
      style={style}
      a11yProps={a11yProps}
